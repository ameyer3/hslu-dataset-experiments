...
# Read both datasets
df_left <- read.csv("Marine Microplastic Concentrations-left.csv", stringsAsFactors = FALSE)
df_right <- read.csv("Marine Microplastic Concentrations-right.csv", stringsAsFactors = FALSE)
